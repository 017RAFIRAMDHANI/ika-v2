...
export default async function ResultsPage() {
  ...
  return (
    <AppShell user={user}>
      <div className="page-heading"><div><span className="eyebrow">Rekapitulasi</span><h1>Hasil Suara</h1><p>Total suara tercatat: {total}. Data ditampilkan langsung dari nilai perolehan kandidat pada sistem.</p></div><span className="live-chip"><span className="live-dot" /> {total} Suara Masuk</span></div>
